...
<!DOCTYPE html>
<html ng-app="submitFormApp"  ng-controller="submitFormController">
<head>
                                        ...
                                        <tbody>
                                            <tr ng-repeat="(index,order) in orders  ">
                                                ...
                                                <td>
                                                        ...
                                                        <button ng-if="order.status == false" type="button" class="btn btn-default" ng-click="changeStatus(order.id)" name="stauts">
                                                            ايقاف
                                                        </button>
